...
issueTrackerServices.factory("photoService", function($rootScope, dataService){
	...
	loadPhotoes = function(callbackHandler){
		...
		dataService.getEntities("photo", function(data){
	...
	loadPhotoesByPageNo = function(startNo, endNo, callbackHandler){
		dataService.getEntitiesByPageNo("photo", startNo, endNo, function(data){
			var newPhotoes = photoes;
			if(data){
				setPhotoes(data);
				newPhotoes = data;
	...
	loadPhoto = function(id, callbackHandler){
		dataService.getEntity("photo", id, function(data){
	...
	createPhoto = function(photo, callbackHandler){
		delete photo.id;
		dataService.createEntity("photo/photo", photo, function(data){
			if(data){
				addPhoto(data);
	...
	updatePhoto = function(photo, callbackHandler){
		dataService.updateEntity("photo/photo", photo, function(data){
			if(data){
	...
	deletePhoto = function(index, callbackHandler){
		...
		dataService.deleteEntity("photo/photo/" + photo.id, function(data){
			removePhoto(index);
