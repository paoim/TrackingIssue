...
issueTrackerApp.controller("IssuesController", function($scope, $modal, $log, $timeout, $filter, pageService, issueService, contactService, statusService, todoService, inputFileService, utilService) {
	var newPage = {
		isDetailPage : false,
		title : "Issues List",
